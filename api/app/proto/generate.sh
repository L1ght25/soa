...
python3 -m grpc_tools.protoc -I${task_prefix}/proto --python_out=${task_prefix}/api/app/proto/ --pyi_out=${task_prefix}/api/app/proto/ --grpc_python_out=${task_prefix}/api/app/proto/ ${task_prefix}/proto/statistics_service.proto
